                    ...
                    <div className="col-10">
                        <div className="border-bottom border-top border-primary bg-light py-5 px-4">
                            ...
                            <form onSubmit={handleSubmit} method='post' className="row g-4 form">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <select className="form-select border-primary p-2" aria-label="Default select example" name='country' value={formData.country} onChange={inputChange}>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <input type="date" className="form-control border-primary p-2" name='birthDate' placeholder="Select Birth Date" value={formData.birthDate} onChange={inputChange}/>
                                </div>
                                <div className="col-lg-12 col-md-6">
                                    <textarea type="text" className="form-control border-primary p-2" name='objective' placeholder="Enter Your Objective" ></textarea>
                                </div>

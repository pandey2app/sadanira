...
const PostView = () => {
    ...
    if (!postFromState.title) {
        return <p className="text-center text-danger">Error fetching post</p>;
    }
    ...
    return (
        <div className="container mt-3">
            <div className="">
                ...
                <div className="image-container overflow-hidden my-4" style={{ maxHeight: '500px' }}>
                    <img
                        className="img-fluid mx-auto d-block"
                        style={{ maxHeight: '500px', objectFit: 'cover' }}
                        src={postFromState.image ?? `${process.env.REACT_APP_BACKEND_ROOT_ADDRESS}/img/default_post_image.jpg`}
                        alt={postFromState.title}
                    />
                </div>

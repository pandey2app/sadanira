...
export const getUserFromAPI = async () => { 
    try {
        const response = await axios.get(`${process.env.REACT_APP_BACKEND_ROOT_ADDRESS}/api/user`, { withCredentials: true });
...
export const getUserByIdFromAPI = async (id) => { 
    try {
        const response = await axios.get(`${process.env.REACT_APP_BACKEND_ROOT_ADDRESS}/user/${id}`, { withCredentials: true });
...
export const addUserToAPI = async (userData) => {
    try {
        const response = await axios.post(`${process.env.REACT_APP_BACKEND_ROOT_ADDRESS}/api/user/add`, userData, { withCredentials: true });
...
export const loginUserToAPI = async (user) => {
    try {
        const response = await axios.post(`${process.env.REACT_APP_BACKEND_ROOT_ADDRESS}/api/user/login`, user, { withCredentials: true });

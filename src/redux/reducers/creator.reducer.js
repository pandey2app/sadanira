...
const initialState = {
    creators : localStorage.getItem("creators") ? JSON.parse(localStorage.getItem("creators")):[...creatorsData],
...
export const creatorReducer = (state = initialState, action )=>{
    switch (action.type) {
        ...
        localStorage.setItem("creators",JSON.stringify(action.payload??[...creatorsData]))
        return{
            ...state,
